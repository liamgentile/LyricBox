...
#folk_model import
folk_model = load_model('models/folk_lyrics_RNN_model4.h5', compile=False)
#pop_model import
pop_model = load_model('models/pop_lyric_model.h5', compile=False)
#hiphop_model import
hiphop_model = load_model('models/rap_lyric_model.h5', compile=False)
