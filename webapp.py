...
t_f = open('https://lyricbox.s3.us-east-2.amazonaws.com/tokenizers/folk_tokenizer.pkl', 'r')
tokenizer_folk = pickle.load(t_f)

t_p =  open('https://lyricbox.s3.us-east-2.amazonaws.com/tokenizers/pop_tokenizer.pkl', 'r') 
tokenizer_pop = pickle.load(t_p)

t_h =  open('https://lyricbox.s3.us-east-2.amazonaws.com/tokenizers/rap_tokenizer.pkl', 'r') 
